---
title: "Run Evalua Javiera Locally for Development and Testing"
sidebarTitle: "Local Setup"
description: "Set up and run Evalua Javiera on your local machine using Python, FastAPI, and uvicorn. Get a live server at localhost:8000 in minutes."
---
